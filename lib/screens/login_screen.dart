                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Username',
                            hintStyle: TextStyle(color: const Color.fromARGB(255, 12, 12, 12).withOpacity(0.7)),
                            prefixIcon: Icon(
                              Icons.person,
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Password',
                            hintStyle: TextStyle(color: const Color.fromARGB(255, 14, 13, 13).withOpacity(0.7)),
                            prefixIcon: Icon(
                              Icons.lock,
                              color: Colors.cyan.withOpacity(0.7),
                            ),
